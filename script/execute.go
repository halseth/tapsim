...
//
// If internalKeyBytes is empty, a random key will be generated.
func Execute(inputKeyBytes, outputKeyBytes []byte, pkScript []byte, witness [][]byte, interactive bool) error {
